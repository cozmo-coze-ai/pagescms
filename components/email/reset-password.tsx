...
// Password reset link, sent by better-auth's requestPasswordReset flow
// (lib/auth.ts). Styled to match the invite email.
export const ResetPasswordEmailTemplate = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>Reset your Coze CMS password</Preview>
      <Tailwind>
        <Body
        ...
        >
          <Container className="my-[40px] mx-auto p-[20px] max-w-[465px]">
            ...
            <Text
              ...
              style={{ color: emailTheme.foreground }}
            >
              Someone requested a password reset for your Coze CMS account.
            ...
            >
              This link expires in 1 hour and was intended for{" "}
              <Link
                href={`mailto:${email}`}
                className="underline"
